"""
Training script for SimpleVisionGPT.
This script adapts the nanoGPT training loop for vision tasks,
using the simplified model without RoPE.
"""
...
wandb_run_name = 'vision-gpt-simple'
...
# -----------------------------------------------------------------------------
# Allow command line overrides or a separate config file
...
def create_model():
    # Initialize a new SimpleVisionGPT model
    config_args = dict(
        img_size=img_size,
